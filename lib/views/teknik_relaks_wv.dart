...
class TeknikRelaksasi_WV0 extends StatefulWidget {
  @override
  _TeknikRelaksasi_WV0State createState() => _TeknikRelaksasi_WV0State();
}

class _TeknikRelaksasi_WV0State extends State<TeknikRelaksasi_WV0> {
    ...
    Widget w_webview0 = WebView(
            ...
            onMessageReceived: (JavascriptMessage message) {
              ...
              if(message.message == "clickBackFromJS"){
                ...
                if(ms2[0] == 'clicFromJS_lihatDiYoutube'){
                  //MyFunct02().print00_fromURL(ms2[1]) ;
      ...
      onPageFinished: (String url) {
        ...
        if(idf_user!="" && ulang1==0){
          ...
          _webViewController.loadUrl(AppConfig().url_APIRoot+'mobile/mob_teknik_relaksasi_vid.php?idf_user='+idf_user);
          debugPrint("lagiiiii");
          setState(() {
            ulang1 += 1;
          });
          ...
          NavigationDelegate(
            ...
            onPageFinished: (String url) {
              ...
              if (idf_user != "" && ulang1 == 0) {
                ...
                String newUrl = AppConfig().url_APIRoot + 'mobile/mob_teknik_relaksasi_vid.php?idf_user=' + idf_user;
