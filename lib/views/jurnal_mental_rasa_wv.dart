...
class JurnalMentalRasa_WV0 extends StatefulWidget {
  @override
  _JurnalMentalRasa_WV0State createState() => _JurnalMentalRasa_WV0State();
}

class _JurnalMentalRasa_WV0State extends State<JurnalMentalRasa_WV0> {
          ...
          NavigationDelegate(
            ...
            onPageFinished: (String url) {
              ...
              if (idf_user != "" && ulang1 == 0) {
                ...
                String newUrl = AppConfig().url_APIRoot + 'mobile/mob_jurnal_perasaan.php?idf_user=' + idf_user;
