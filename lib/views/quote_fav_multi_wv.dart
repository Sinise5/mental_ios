...
class QuoteFavoritM_WV0 extends StatefulWidget {
  @override
  _QuoteFavoritM_WV0State createState() => _QuoteFavoritM_WV0State();
}

class _QuoteFavoritM_WV0State extends State<QuoteFavoritM_WV0> {
    ...
    Widget w_webview0 = WebView(
      ...
      onPageFinished: (String url) {
        ...
        if(idf_user!="" && ulang1==0){
          ...
          _webViewController.loadUrl(AppConfig().url_APIRoot+'mobile/mob_quote_pav.php?idf_user='+idf_user);
          debugPrint("lagiiiii");
          setState(() {
            ulang1 += 1;
          });
          ...
          NavigationDelegate(
            ...
            onPageFinished: (String url) {
              ...
              if (idf_user != "" && ulang1 == 0) {
                ...
                String newUrl = AppConfig().url_APIRoot + 'mobile/mob_quote_pav.php?idf_user=' + idf_user;
