...
class JurnalMentalSayang_WV0 extends StatefulWidget {
  @override
  _JurnalMentalSayang_WV0State createState() => _JurnalMentalSayang_WV0State();
}

class _JurnalMentalSayang_WV0State extends State<JurnalMentalSayang_WV0> {
    ...
    Widget w_webview0 = WebView(
      ...
      onPageFinished: (String url) {
        ...
        if(idf_user!="" && ulang1==0){
          ...
          _webViewController.loadUrl(AppConfig().url_APIRoot+'mobile/mob_jurnal_menyayangi_diri.php?idf_user='+idf_user);
        }
      },
          ...
          NavigationDelegate(
            ...
            onPageFinished: (String url) {
              ...
              if (idf_user != "" && ulang1 == 0) {
                ...
                String newUrl = AppConfig().url_APIRoot + 'mobile/mob_jurnal_menyayangi_diri.php?idf_user=' + idf_user;
  ...
  refreshUlang() {
    ...
    if(idf_user!="" && ulang1==0){
     // _webViewController.loadUrl(AppConfig().url_APIRoot+'mobile/mob_jurnal_menyayangi_diri.php?idf_user='+idf_user);
      _webViewController.loadRequest(Uri.parse(AppConfig().url_APIRoot+'mobile/mob_jurnal_menyayangi_diri.php?idf_user='+idf_user));
      debugPrint("lagiiiii");
      setState(() {
        ulang1 += 1;
      });
